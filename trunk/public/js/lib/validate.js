/*
 *Examples: http://tetlaw.id.au/view/javascript/really-easy-field-validation
*
*   * required (not blank)
	...
	test : function(name, elm, useTitle) {
		...
		if(Validation.isVisible(elm) && !v.test($F(elm), elm)) {
			if(!elm[prop]) {
				...
				if(true || typeof Effect == 'undefined') { //disable effect
...
Validation.addAllThese([
    ...
    ['validate-future-date', 'Please use a future date.', function(v){
            var ymd = v.gsub('-', '/');
            var choosedDate = new Date(ymd);
            var theTime = new Date();
            if(choosedDate.getTime() < theTime.getTime()){
                return false;
            }
            return true;
    }]
