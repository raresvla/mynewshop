...
// -------------------------------------------------------------------
var dhtmlwindow={
imagefiles:['config/windowfiles/min.gif', 'config/windowfiles/close.gif', 'config/windowfiles/restore.gif', 'config/windowfiles/resize.gif'], //Path to 4 images used by script, in that order
